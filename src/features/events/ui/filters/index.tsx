...
import { FILTER_TYPES, useFiltersStore } from 'features/events/store/store';
...
export const Filters = () => {
  ...
  const { filters, changeFilter, resetAll } = useFiltersStore();
  const hasSelectedFilters = useFiltersStore(selectors.hasSelectedFilters);
